...
export default function FactCheckerUI() {
  ...
  const modeBtn = (active) => ({
    ...
    background: active ? "linear-gradient(135deg,#534AB7,#7F77DD)" : "rgba(255,255,255,0.05)",
  ...
  return (
    <div style={{ minHeight:"100vh", padding:"2rem 1rem", fontFamily:"'DM Sans', system-ui, sans-serif" }}>
      <div style={{ maxWidth:840, margin:"0 auto" }}>
        ...
        <div style={{ textAlign:"center", marginBottom:"2rem" }}>
          <div style={{ display:"inline-flex", alignItems:"center", gap:10, background:"linear-gradient(135deg,#534AB7,#1D9E75)", borderRadius:50, padding:"8px 22px", marginBottom:"1.25rem" }}>
            ...
            <span style={{ color:"#fff", fontSize:14, fontWeight:500 }}>FactChecker Groupe4</span>
          </div>
          <h1 style={{ fontFamily:"'Syne', sans-serif", fontSize:"clamp(28px,5vw,48px)", fontWeight:800, letterSpacing:"-1.5px", lineHeight:1.1, margin:"0 0 8px" }}>
  Vérifiez la{" "}
  <span style={{ background:"linear-gradient(90deg,#6ee7b7,#a78bfa)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>
    fiabilité
  </span>{" "}
  d'un article
</h1>
          <p style={{ fontSize:14, color:"#a7a9be", margin:"0 0 1rem" }}>Analyse parallèle via Wikipedia · Google News </p>
        ...
        <div style={{ background:"#1a1930", border:"0.5px solid rgba(255,255,255,0.08)", borderRadius:16, padding:"1.5rem", marginBottom:"1rem" }}>
          ...
          {mode === "text" && <>
            ...
            <textarea value={text} onChange={e => { setText(e.target.value); setError(""); }} placeholder="Collez votre article ici (min. 50 caractères)..." rows={7} spellCheck={false}
